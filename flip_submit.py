...
FIRST_NAMES = [
    ...
    "Jeffrey", "Ryan", "Jacob", "Nathan", "Tyler", "Aaron", "Justin",
    ...
    "Megan", "Hannah", "Olivia", "Sophia", "Grace", "Victoria",
    # Asian
    "Wei", "Jin", "Hiro", "Yuki", "Kenji", "Haruto", "Sora", "Ren",
    "Minh", "Linh", "Anh", "Trang", "Huy", "Quang", "Mai",
    "Jisoo", "Minjun", "Seoyeon", "Hyun", "Joon", "Daehan",
    "Arjun", "Priya", "Rohan", "Ananya", "Vikram", "Kavya", "Aditya",
    # European
    "Lukas", "Mateus", "Pavel", "Elena", "Natasha", "Ivan", "Olga",
    "Sven", "Freja", "Mikael", "Astrid", "Henrik", "Greta",
    "Luca", "Giulia", "Marco", "Sofia", "Andrea", "Chiara",
    # Middle Eastern / African
    "Omar", "Layla", "Yusuf", "Amina", "Tariq", "Zainab", "Karim",
    "Kwame", "Amara", "Zola", "Themba", "Ngozi", "Chidi"
]
...
LAST_NAMES = [
    ...
    "Wright", "Scott", "Torres", "Nguyen", "Hill", "Flores", "Cooper",
    "Bennett", "Foster", "Reed", "Hayes", "Bailey", "Murphy",
    # Asian
    "Tanaka", "Sato", "Watanabe", "Kim", "Park", "Choi", "Tran",
    "Pham", "Hoang", "Patel", "Sharma", "Gupta", "Singh", "Reddy",
    "Wang", "Zhang", "Li", "Chen", "Liu", "Yang",
    # European
    "Novak", "Kowalski", "Rossi", "Bianchi", "Andersson", "Johansson",
    "Schmidt", "Mueller", "Dubois", "Lefevre", "Petrov", "Ivanova",
    # Middle Eastern / African
